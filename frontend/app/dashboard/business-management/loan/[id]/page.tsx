...
export default function LoanDetailPage() {
  ...
  const handleDeleteLoan = async () => {
    ...
    try {
      ...
      router.push("/dashboard/business-management/loan");
    } catch (error: any) {
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 mt-8">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              ...
              <div className="flex items-center gap-3">
                ...
                {(currentUser?.role === "ADMIN" ||
                  ...
                  (loan?.status === "DRAFT" ||
                    ...
                    <Button
                      ...
                      onClick={() =>
                        router.push(
                          `/dashboard/business-management/loan/edit/${loan.id}`
                        )
                      }
                ...
                {/* Delete button - ADMIN only, any status */}
                {currentUser?.role === "ADMIN" && (
                  <Button
                    variant="destructive"
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              application for {loan?.loanNumber}.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 space-y-6 sm:space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          <SummaryCard
            ...
            value={formatCompactNumber(Number(loan?.principalAmount || 0), "₦")}
          ...
          <SummaryCard
            ...
            value={formatCompactNumber(Number(loan?.processingFeeAmount || 0), "₦")}
